...
export async function POST(req) {
  try {
    ...
    try {
      ...
      return NextResponse.json({ error: "Could not read the Excel file" }, { status: 500 });
    }
      ...
      messages: [
        {
          ...
          content: [
            {
              type: "text",
              text: `The following text was extracted from an Excel spreadsheet containing daily sales records for Crown Coffee cafe.
