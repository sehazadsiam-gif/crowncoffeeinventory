    ...
    <div style="font-family: 'Segoe UI', sans-serif; background: #FAFAFA; padding: 40px 20px;">
      <div style="max-width: 600px; margin: 0 auto;">
        ...
        <div style="text-align: center; margin-bottom: 32px;">
          ...
          <p style="color: #6B3A2A; font-weight: 700; margin: 0 0 6px 0;">You will receive your physical membership card.</p>
          <p style="color: #9C8A76; margin: 0; font-size: 13px;">System: Tap at counter when you enter.</p>
        </div>
