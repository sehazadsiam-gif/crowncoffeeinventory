    ...
    <div id="payslip-container" style="font-family: 'Segoe UI', sans-serif; padding: 40px; max-width: 800px; background: #FAFAFA; color: #1C1410;">
      ...
      <div style="margin-bottom: 24px;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
          ...
          <tr style="border-bottom: 1px solid #E0E0E0;">
            <td style="padding: 16px; font-size: 14px;">Morning Food (7:30-9:00 AM)</td>
          ...
          <tr style="border-bottom: 1px solid #E0E0E0;">
            <td style="padding: 16px; font-size: 14px;">Lunch + Dinner (${payrollData.present_days} days × 120)</td>
