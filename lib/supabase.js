...
if (!supabaseUrl || !supabaseAnonKey) {
  ...
  console.error('CRITICAL: NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY are missing from environment variables.')
  console.error('Please add them to your hosting provider\'s environment variable settings (Netlify: Site config → Environment variables).')
} else {
