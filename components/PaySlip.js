...
export default function PaySlip({ data, onClose }) {
  ...
  if (Number(payroll.miscellaneous) < 0) {
    deductions.push({ label: miscLabel, amount: Math.abs(Number(payroll.miscellaneous)) })
  }
      ...
      >
        <div style={{ width: '100%', maxWidth: '800px', color: 'black', fontFamily: 'serif' }}>
          ...
          <div style={{ textAlign: 'center', borderBottom: '2px solid black', paddingBottom: '20px', marginBottom: '30px' }}>
            <h1 style={{ fontSize: '36px', margin: '0 0 10px 0', textTransform: 'uppercase', letterSpacing: '2px' }}>
              Crown Coffee
            </h1>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
              <span style={{
                padding: '5px 15px',
                border: '2px solid ' + paidBorderColor,
                color: paidTextColor,
                fontWeight: 'bold',
              ...
              <h2 style={{ margin: 0, fontSize: '28px' }}>
                {'\u09F3'}{payroll.final_salary?.toLocaleString()}
              </h2>
            </div>
          </div>

          <div style={{ marginTop: '80px', display: 'flex', justifyContent: 'space-between' }}>
            <div style={{ borderTop: '1px solid black', paddingTop: '10px', width: '200px', textAlign: 'center', fontSize: '14px' }}>
              Employer Signature
            </div>
            <div style={{ borderTop: '1px solid black', paddingTop: '10px', width: '200px', textAlign: 'center', fontSize: '14px' }}>
              Employee Signature
